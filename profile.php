    ...
    <aside class="sidebar" data-sidebar>
      <div class="middle-sidebar">
        <ul class="sidebar-list">
          ...
          <li class="sidebar-list-item " onclick="makeElementActive(this)">
            <a href="#" class="sidebar-link">
              <svg class="sidebar-icon" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="sidebar-icon">
                <g>
              ...
              <div class="hidden-sidebar sidebar-link-text ">Paramètres</div>
            </a>
          </li>
